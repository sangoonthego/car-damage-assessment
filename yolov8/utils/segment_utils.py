...
from car_severity.severity_level import SeverityLevel

class ObjectSegmenter:
    def __init__(self, model_path = r"D:\saves\AI Research\Project\car_damage_assessment\runs\detect\train2\weights\best.pt", output_dir="static/segment_masks"):
...
if __name__ == "__main__":
    ...
    result = segmenter.segment_objects(image_path)
